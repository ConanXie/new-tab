...
class Wallpaper extends Component {
    ...
    fetchWallpaper = async event => {
        ...
        try {
            ...
            Wallpaper.saveUpdateTime()
        } catch (e) {
            this.fetchFailed();
            Wallpaper.errorHandler(e)
        }
    };
    ...
    readImage = event => {
        ...
        fr.onloadend = () => {
            this.originImage = fr.result;
            const buffer = Wallpaper.base64ToBinary(this.originImage);
            const {blurRadius} = this.props.settings;
    ...
    saveImage(blob, callback) {
        const errorHandler = Wallpaper.errorHandler;
        window.webkitRequestFileSystem(window.TEMPORARY, this.spaceSize, fs => {
        ...
        return (
            <div>
                <div className="wallpaper-settings">
                    <Paper className="header-bar" style={{backgroundColor: muiTheme.palette.primary1Color}}
                           rounded={false} zDepth={1}>
                        <div className="tool-bar">
                            <div className="bar-left">
                                <div className="bar-label"
                                     style={{color: muiTheme.palette.alternateTextColor}}>{chrome.i18n.getMessage('desktop_header_title')}</div>
                            </div>
                    ...
                    <section>
                        <div className="area">
                            ...
                            <div className="column no-padding-right">
                                ...
                                >
                                    <MenuItem value={1}
                                              primaryText={chrome.i18n.getMessage('wallpaper_source_internet')}/>
                            ...
                            <div className="border">
                                ...
                                <div className="slider-wrap">
                                    <BrightnessMedium color={muiTheme.palette.secondaryTextColor}
                        ...
                        <div className="area">
                            ...
                            <div className="border">
                                ...
                                <div className="slider-wrap">
                                    <ActionOpacity color={muiTheme.palette.secondaryTextColor}
                                                   style={styles.sliderIcon}/>
                                    <Slider
                                        disabled={settings.hideSearch}
                    ...
                    >
                        <div className="color-circle">
                            <input type="color" id="color" hidden onInput={this.getColor} value={color} ref="color"
                                   onChange={() => {
                                   }}/>

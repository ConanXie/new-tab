                                ...
                                <a className="bookmark-link" href={value.url} key={index} title={value.title}>
                                    <ListItem
                                        ...
                                        leftIcon={<div style={{
                                            ...
                                            height: 16,
                                            margin: 8,
                                            content: `-webkit-image-set(url("chrome://favicon/size/16@1x/${value.url}") 1x, url("chrome://favicon/size/16@2x/${value.url}") 2x)`
                                        }}/>}
                                        className="bookmark"
                    ...
                    <a className="bookmark-link" href={url} key={id} title={title}>
                        <ListItem
                            ...
                            leftIcon={<div style={{
                                ...
                                height: 16,
                                margin: 8,
                                content: `-webkit-image-set(url("chrome://favicon/size/16@1x/${url}") 1x, url("chrome://favicon/size/16@2x/${url}") 2x)`
                            }}/>}
                        />
                    </a>
                )
    ...
    render() {
        ...
        return (
            <div className="bookmark-component">
                    ...
                    <header style={{backgroundColor: muiTheme.palette.primary1Color}}>
                        <div className="search-box" onClick={this.openSearch}>
                            ...
                            <div className="placeholder"
                                 style={{color: muiTheme.palette.alternateTextColor}}>{chrome.i18n.getMessage('bookmarks_search_placeholder')}</div>
                        </div>
                        <IconButton
                ...
                >
                    <section className={classNames('folder-list', {'empty': !bookmarks})} ref="wrapper"

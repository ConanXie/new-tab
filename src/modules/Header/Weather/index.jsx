            ...
            <div className={classNames('weather-component', {'empty': empty})}>
                ...
                {data.forecast && (
                    <div className="weather-interface"
                         style={{backgroundColor: primary1Color, color: alternateTextColor}}>
                        <header>
                                ...
                                <div className="state">
                                    {data.aqi && (
                                        <p className="qlty">
                                            ...
                                            <span/>{data.aqi.city.qlty + ' '}{data.aqi.city.pm25}
                                        </p>
                                    )}
                                    <p className="humidity">
                                        <HumidityIcon color={alternateTextColor}
                                                      style={{...style.icon, ...style.humidity}}/>
                                        <span>{chrome.i18n.getMessage('weather_humidity')} {data.now.humidity}%</span>
                                    </p>
                                    <p className="wind">
                                        <MapsNavigation color={alternateTextColor} style={{
                                            ...style.icon,
                                            transform: `rotate(${180 + data.now.wind.direction * 1}deg)`
                                        }}/>

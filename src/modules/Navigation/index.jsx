                    ...
                    <div className={classNames('websites-wrap', {'empty': isEmpty})}>
                                    ...
                                    return (
                                        ...
                                        >
                                            <FlatButton
                                                ...
                                                href={link}
                                                target={target}
                                                icon={<img className="favicon"
                                                           src={`https://www.google.com/s2/favicons?domain=${link.replace(/http(s)?:\/\//, '')}`}
                                                           alt={name} onError={this.imgError}/>}
                                                className="website-link"
                                                style={style.website}
                                                labelStyle={labelStyle}
                                                onClick={this.checkClick}
                                            />
                                            <i className={classNames('handle-btn edit-btn', {'show': edit})}
                                               onClick={() => {
                                                   this.handleEdit(index, name, link)
                                               }}>
                                                <ModeEdit
                                                    color={grey500}
                                                    hoverColor={grey600}
                                            ...
                                            <i className={classNames('handle-btn delete-btn', {'show': edit})}
                                               onClick={() => {
                                                   this.handleDelete(name, index)
                                               }}>
                                                <ContentClear
                                                    color="#fff"
                        ...
                        {isClassified && classifiedStore.map((item, cIndex) => {
                            return (
                                <div
                                    key={Math.random()}
                                    className={classNames('classification', {
                                        'empty': !item.set.length,
                                        'editing': edit
                                    })}
                                    style={{
                                        minHeight: this.margin + this.websiteHeight,
                                        height: Math.ceil(item.set.length / this.row) * (this.websiteHeight + this.spacingY)
                                    }}
                                >
                                    <div className="classification-name" style={{color: classificationColor}}>
                                        {edit && item.name !== 'unclassified' && (
                                            <TextField
                                                ...
                                                onBlur={e => {
                                                    this.changeClassificationName(e, cIndex)
                                                }}
                                            />
                                        )}
                                        {(!edit && item.name !== 'unclassified') && (
                                        ...
                                        {item.set.map((value, index) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <i className={classNames('handle-btn edit-btn', {'show': edit})}
                                                       onClick={() => {
                                                           this.handleEdit(index, name, link, cIndex)
                                                       }}>
                                                        <ModeEdit
                                                            color={grey500}
                                                            hoverColor={grey600}
                                                    ...
                                                    <i className={classNames('handle-btn delete-btn', {'show': edit})}
                                                       onClick={() => {
                                                           this.handleDelete(name, index, cIndex)
                                                       }}>
                                                        <ContentClear
                                                            color="#fff"
                                                            style={style.deleteHandleIcon}
                                    ...
                                    {item.name !== 'unclassified' && (
                                        <FlatButton
                                            ...
                                            icon={<ContentClear/>}
                                            onClick={() => {
                                                this.deleteClassification(cIndex)
                                            }}

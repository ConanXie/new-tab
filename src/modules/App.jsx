...
class App extends Component {
    ...
    componentDidMount() {
        if (!this.state.darkMode) {
            ...
            App.setBackground(this.darkTheme.paper.backgroundColor)
        }
        ...
        window.webkitRequestFileSystem(window.TEMPORARY, 10 * 1024 * 1024, fs => {
            fs.root.getFile('wallpaper.jpg', {create: false}, () => {
            }, () => {
    ...
    changeBackground() {
        ...
        App.setBackground(color, image, mask)
    }

    static setBackground(color = '#fff', image = 'none', strength = 0) {

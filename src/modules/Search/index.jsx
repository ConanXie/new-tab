                        ...
                        {engines.map((engine, index) => {
                            ...
                            return (
                                <MenuItem
                                    ...
                                    value={index}
                                    primaryText={name}
                                    onClick={() => this.changeEngine(index)}
                        ...
                        <div className="input-box">
                            ...
                            <IconButton
                                ...
                                iconStyle={{
                                    ...
                                    opacity: transparentSearchInput ? 0 : ''
                                }}
                            >
                                <SearchIcon/>
                            </IconButton>
                                                ...
                                                if (index !== this.engineIndex) {
                                                    return (
                                                        <li
                                                            key={id}
                                                            onClick={() => {
                                                                this.searchFrom(index)
                                                            }}
                                                        >
                                                            {chrome.i18n.getMessage('search.from')} <span
                                                            style={{color: muiTheme.palette.primary1Color}}>{name}</span>
                                                        </li>
                                                    )
                                                }
                                            })}
